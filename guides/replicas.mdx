...
See the [db_instance_automated_backups_replication submodule reference](/reference/db-instance-automated-backups-replication) for full documentation and usage examples.
